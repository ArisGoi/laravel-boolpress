...
class CategoryController extends Controller
{
    ...
    public function update(Request $request, Category $category)
    {
        ...
        //redirect
        return redirect()->route('admin.categories.index', $category->id)->with('success', "La categoria {$category['id']} è stata aggiornata");;
    }
    ...
    {
        $category->delete();
        return redirect()->route('admin.categories.index')->with('success', "La categoria {$category['id']} è stata cancellata");
    }
}
